...
#docker build -t angular-workbench -f dockers/angular_devserver/Dockerfile ang/
wait

docker run -i -d --name node -p 5000:5000 -v $PWD/PRF-Backend:/var/munka/PRF-Backend node-backend
#docker run -i -d --name angular -p 4200:4200 -v $PWD/prfgyak:/var/munka angular-workbench
wait
